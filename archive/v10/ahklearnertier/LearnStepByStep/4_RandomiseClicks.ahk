...
Gui, Add, Text, section w200, 1. Pressing 1 will trigger a click at a randomised location using realistic mouse movements
...
Random, y, 700, 800
; Do not use % sign when using a function with braces
MoveMouse(x, y)
; Using Click, put %% around the number before using
Click, %x%, %y%
return
